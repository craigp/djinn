...
What I really want, and plan to work towards, is for Djinn to offer something 
more akin to a daemon DSL, something like this:
  ...
  class Basic
    ...
    djinn do
      ...
      on_start do
        # do some cool daemon stuff in the background
      end
      
      on_run do
        # do some slightly less cool stuff in the foreground
      end
    
      on_exit do
        log "Handle a graceful exit"
      end
