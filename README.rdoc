...
from, name the same as the djinn class, so in this case "basic.yml". It will by
...
It's ugly, but the solution is minimal, and so flexible I think. The rails daemon
helpers include some option parsing and so forth and do a little more for you.
